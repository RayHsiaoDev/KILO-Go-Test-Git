...
class LevelSkill1PageModelsCell: UIView, LevelSkill1PageModelsDelegate {
    ...
    var vc = LevelSkill1PageModels(type: .bear)
    ...
    func configureUI() {
        ...
        switch type {
        case .bear:
            skillTitle.text = "攻擊對方視線，造成暈眩效果2秒"
            skillValue.text = "攻擊力 + \(Value)"
